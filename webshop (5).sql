...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 14. Dez 2020 um 11:28
...
-- Datenbank: `webshop`
--
CREATE DATABASE IF NOT EXISTS `webshop_melanie_sebastian` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `webshop_melanie_sebastian`;
...
(57, '2020-01-23 12:55:10', 'Budde', 'Sebastian', 'basti_budde@web.de', 'Am Schanzenberg 4a', 27404, 'Zeven', NULL, 'Storniert', '664.86'),
(58, '2020-12-10 13:19:55', 'Budde', 'Sebastian', 'basti_budde@web.de', 'Am Schanzenberg 4a', 27404, 'Zeven', NULL, 'In Bearbeitung', '34.99'),
(59, '2020-12-13 01:26:17', 'Budde', 'Sebastian', 'basti_budde@web.de', 'Am Schanzenberg 4a', 27404, 'Zeven', NULL, 'In Bearbeitung', '564.97'),
(60, '2020-12-13 15:15:02', 'Budde', 'Sebastian', 'basti_budde@web.de', 'Am Schanzenberg 4a', 27404, 'Zeven', NULL, 'In Bearbeitung', '34.99'),
(61, '2020-12-14 09:52:30', 'Budde', 'Sebastian', 'basti_budde@web.de', 'Am Schanzenberg 4a', 27404, 'Zeven', NULL, 'In Bearbeitung', '79.80');
...
(8, 'Max', 'Mustermann', 'Max@Mustermann.de', '1234567890', 11011, 'Musterstedt', 'Musterstraße 4', 0);
...
CREATE TABLE `produkt` (
  ...
  `Kategorie` enum('Action','Adventure','Science-Fiction','Monitore','Tastaturen','Maeuse','Headsets','Figuren','Kleidung','Accessories') NOT NULL,
...
--
ALTER TABLE `bestellung`
  MODIFY `ID_Bestellung` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT für Tabelle `kunde`
--
ALTER TABLE `kunde`
  MODIFY `ID_Kunde` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `produkt`
  MODIFY `ID_Produkt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
