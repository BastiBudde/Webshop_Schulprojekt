<?php
    ...
    // https://www.ihk-muenchen.de/de/Service/Recht-und-Steuern/Vertragsrecht/mustervertraege/agb-webshop.html

    pageHead("AGB");

    echo"<div class='agbContainer hugeMarginBottom'>
            <dl>
                <h1>Allgemeine Geschäftsbedingungen</h1>
                
                <dt> <h2>Geltungsbereich</h2> </dt>
                    <dd>
                        Für alle Lieferungen von GamingHeaven GmbH. (nachfolgend GamingHeaven) an Verbraucher gelten diese Allgemeinen Geschäftsbedingungen (AGB).
                        Verbraucher ist jede natürliche Person, die ein Rechtsgeschäft zu einem Zwecke abschließt, der überwiegend weder ihrer gewerblichen noch ihrer selbstständigen beruflichen Tätigkeit zugerechnet werden kann.
                    </dd>
                    

                <dt> <h2>Vertragspartner</h2> </dt>
                    <dd>
                        Der Kaufvertrag kommt zustande mit GamingHeaven GmbH., Inhaber: Melanie Meyer u. Sebastian Budde, Demostr. 1, 12345 Demostadt, Handelsregister: Amtsgericht Demostadt, HRA 12345.
                        Vertragsschluss
                    </dd>
                    <dd>    
                ...
                <dt> <h2>Widerrufsrecht</h2> </dt>
                    ...
                    <dd>    
                        <dl>
                            ...
                            <dt> <h3>Folgen des Widerrufs</h3> <dt>
                                <dd>
                            ...
                            <dt> <h3>- Ende der Widerrufsbelehrung -</h3> <dt>
                ...
                <dt> <h2>Preise und Versandkosten</h2> </dt>
                    <dd>
                ...
                <dt> <h2>Eigentumsvorbehalt</h2> </dt>
                    <dd>
                        Bis zur vollständigen Zahlung bleibt die Ware unser Eigentum.
                    </dd>


                <dt> <h2>Streitbeilegung<h2> </dt>
                    <dd>
